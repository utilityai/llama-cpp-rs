...
///
/// This is intentionally a thin wrapper over llama.cpp `common/speculative`.
/// The wrapper owns both target and draft contexts so the raw llama.cpp
/// speculative handle is freed before either context is dropped.
#[derive(Debug)]
